...
public class LoggedSlf4jProperties {
     ...
     * <p>Default: {@code "{h:}{cI:} {c}::{m} called."}</p>
     ...
     * <p>Default: {@code "{h:}{cI:} {c}::{m} called with args: [{a}]"} </p>
     ...
     * <p>Default: {@code "{h:}{rI:} {c}::{m} returned.}</p>
     ...
     * <p>Default: {@code "{h:}{rI} {c}::{m} returned with value: {rV}"}</p>
     ...
     * <p>Default: {@code "{h:}{exI:} {c}::{m} threw a {ex}: {eM}
     * 	at {ec}.{em} ({f}:{L})"}</p>
